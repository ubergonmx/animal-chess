...
/**
 * A class to declare a Lion piece
 */

public class Lion extends Piece implements RiverJump {
    public Lion(PlayerType player, GamePoint point) {
        super(player, PieceType.Lion, point, 7);
    }
